...
export class CreateUser1692168383392 implements MigrationInterface {
    name = 'CreateUser1692168383392'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`records\` (\`id\` int NOT NULL AUTO_INCREMENT, \`price\` int NOT NULL, \`remarks\` varchar(500) NOT NULL, \`createdAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` timestamp(6) NULL, \`categoryId\` int NULL, \`walletId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
