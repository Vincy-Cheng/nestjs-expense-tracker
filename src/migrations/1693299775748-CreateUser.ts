...
export class CreateUser1693299775748 implements MigrationInterface {
    name = 'CreateUser1693299775748'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`records\` (\`id\` int NOT NULL AUTO_INCREMENT, \`price\` decimal NOT NULL, \`date\` date NOT NULL, \`remarks\` varchar(500) NULL, \`createdAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` timestamp(6) NULL, \`categoryId\` int NULL, \`walletId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
